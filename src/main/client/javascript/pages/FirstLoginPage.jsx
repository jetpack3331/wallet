              ...
              <div className="info-container">
                ...
                <div className="info-description">
                  ...
                  <p>
                    ...
                    to decrypt the keys to each address.
                  </p>
                  <p>
          ...
          <Grid container spacing={0} justify="center">
            <Grid item xs={12} sm={10} md>
              <div className="info-container">
                ...
                <div className="info-description">
                  <p>The security of addresses you create within a Hut34 Wallet is linked
                    to the security of your Google account.
                  </p>
                  <p>We strongly recommend that you
                    follow the good advice at
                    <strong>
                      <Link href="https://myaccount.google.com/security" target="_blank"> https://myaccount.google.com/security</Link>
                    </strong>,
                    and setup &apos;2FA&apos;, and other security measures to protect your account.
                  </p>
                  <p>
