...
/**
 * This file is sourced from https://raw.githubusercontent.com/MyCryptoHQ/MyCrypto/develop/common/libs/units.ts
 * All credit to MyCrypto.
 */
...
const Address = input => toBuffer(addHexPrefix(input));

const Data = input => toBuffer(addHexPrefix(input));
